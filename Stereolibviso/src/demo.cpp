...
int main (int argc, char** argv) {
  ...
  param.calib.f  = 679.00; // focal length in pixels
  param.calib.cu = 659.80; // principal point (u-coordinate) in pixels
  param.calib.cv = 186.57; // principal point (v-coordinate) in pixels
